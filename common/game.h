...
struct civ_game {
  ...
  union {
    ...
    struct {
      ...
      bool last_updated_year; /* last_updated is still counted as year in
                               * this game. */
 ...
 * First report is shown at SCORETURN. As report is generated in the end of
 * the turn, first report is already generated at (SCORETURN - 1) */
